<?php 
 get_header(); ?>
    ...
    <?php if (get_option('home_hide_second_section') != '1')  :?>
        ...
        <section class="features-section padding-50">
                        ...
                        <div class="wow fadeInLeft" data-wow-delay="200ms" style="visibility: visible; animation-delay: 200ms; animation-name: fadeInLeft;">
                            ...
                            <div class="row mb-20">
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="feature-item">
                                        <div class="feature-icon">
                                           <img style="width: auto; height:50px;" class="img-fluid" data-src="<?= get_option('home_second_img_one_url'); ?>">
                                        </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="feature-item">
                                        <div class="feature-icon">
                                           <img style="width: auto; height:50px;" class="img-fluid" data-src="<?= get_option('home_second_img_two_url'); ?>">
                                        </div>
                                        <div class="feature-content">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="feature-item">
                                        <div class="feature-icon">
                                           <img style="width: auto; height:50px;" class="img-fluid" data-src="<?= get_option('home_second_img_three_url'); ?>">
                                        </div>
                                        <div class="feature-content">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="feature-item">
                                        <div class="feature-icon">
                                           <img style="width: auto; height:50px;" class="img-fluid" data-src="<?= get_option('home_second_img_four_url'); ?>">
                                        </div>
                                        <div class="feature-content">
                            ...
                            <li>
                            <a href="<?= get_option('home_second_link_url'); ?>" class="default-btn">إحجز خدماتنا الآن <span></span></a>
        ...
        <section class="blog-section bg-grey padding-50">
            <div class="container">
        ...
        <section class="work-process-section padding-50">
                ...
                <div class="row p-0 m-0">
                    <div class="col-lg-3 col-sm-12 sm-padding wow fadeInUp" data-wow-delay="200ms">
                        <div class="work-pro-item">
                            ...
                            <?php echo get_option('home_fourth_content_icon01'); ?>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-12 sm-padding wow fadeInUp" data-wow-delay="200ms">
                        <div class="work-pro-item">
                            ...
                            <?php echo get_option('home_fourth_content_icon02'); ?>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-12 sm-padding wow fadeInUp" data-wow-delay="200ms">
                        <div class="work-pro-item">
                            ...
                            <?php echo get_option('home_fourth_content_icon03'); ?>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-12 sm-padding wow fadeInUp" data-wow-delay="200ms">
                        <div class="work-pro-item">
                            ...
                            <?php echo get_option('home_fourth_content_icon04'); ?>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="service-section bg-grey padding-50">
            <div class="container">
               <div class="section-heading text-center mb-40 wow fadeInUp" data-wow-delay="200ms">
                ...
                <div class="row">
                    ...
                    $cl_categories = get_option('home_fifth_news');
                    $terms =  get_terms( array(
                      'taxonomy' => 'category',
                      'number'  =>  $no,
                      'include' => $cl_categories,
                      'hide_empty'  => false, 
                      'orderby'  => 'include',
                      'order'      => 'ASC',
        ...
        <section class="blog-section bg-grey padding-50">
            <div class="container">
                ...
                <?php 
                    $no         = get_option('eighth_sec_news_num');
        ...
        <?php if (get_option('home_hide_nineth_section') != '1')  :?>
        <section class="faq-section">
...
-->
        ...
        <section class="project-section bg-grey padding-50">
            <div class="container">
